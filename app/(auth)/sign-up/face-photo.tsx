...
export default function TakePhoto() {
  ...
  <View className="flex-1 w-full">
    <View>
      <AuthHeader title="Take Photo of Face" subtitle="Make sure the text are clear, visible and no glare from the light." />
    ...
    <View className="flex-1 w-full gap-4 mt-4">
      <View className="items-center mt-4">
        ...
        >
         ...
         <Note className='mt-4 w-90'>Please ensure there is adequate lighting in the room.</Note>
      </View>
      </View> 
      <View className="w-full pb-4">
        <Link href={{ pathname: '/(auth)/sign-up/personal-info' as never }} asChild>
          <Button
            className="w-full"
