...
export default function TakePhoto() {
    ...
    const pickImage = async () => {
      ...
      const result = await ImagePicker.launchCameraAsync({
        ...
        allowsEditing: true,
        aspect: [3, 2],  // Changed from [1,1] to [3,2] for rectangular crop
        quality: 0.7,
      });
      ...
      <>
        ...
        <AuthLayout withBackground>
          <View className="flex-1 w-full">
            <View>
              <AuthHeader title="Take Photo of ID" subtitle="Make sure the text is clear, visible and there's no glare from the light." />
