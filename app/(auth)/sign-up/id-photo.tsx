...
export default function TakePhoto() {
    ...
    React.useEffect(() => {
  console.log('Current idPhoto:', idPhoto);
}, [idPhoto]);
  ...
  <View className="flex-1 w-full">
    <View>
      <AuthHeader title="Take Photo of  ID" subtitle="Make sure the text are clear, visible and no glare from the light." />
    ...
    <View className="flex-1 w-full gap-4 mt-4">
      <View className="items-center mt-4">
        ...
        >
          {idPhoto ? (
            ...
            <Text className="text-gray-500">Tap to take ID photo</Text>
          )}
      ...
      <View className="w-full pb-4">
        <Link href={{ pathname: '/(auth)/sign-up/face-photo' as never }} asChild>
          <Button
            className="w-full"
            variant="green" size="pill"
