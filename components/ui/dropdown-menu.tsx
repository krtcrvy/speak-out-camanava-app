...
const DropdownMenuTrigger = React.forwardRef<DropdownMenuPrimitive.TriggerRef, DropdownMenuPrimitive.TriggerProps>(
  ({ className, ...props }, ref) => (
    ...
    <DropdownMenuPrimitive.Portal hostName={portalHost}>
      ...
      >
        <DropdownMenuPrimitive.Content
          ref={ref}
          className={cn(
            'z-50 min-w-[8rem] overflow-hidden rounded-xl border border-input bg-background p-1 shadow-md shadow-gray-200',
            open
              ? 'web:animate-in web:fade-in-0 web:zoom-in-95'
